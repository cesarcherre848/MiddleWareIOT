...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_UnitConverter_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_UnitConverter_t qt_meta_stringdata_UnitConverter = {
    {
QT_MOC_LITERAL(0, 13) // "UnitConverter"
...
const QMetaObject UnitConverter::staticMetaObject = { {
    ...
    qt_meta_stringdata_UnitConverter.offsetsAndSize,
    qt_meta_data_UnitConverter,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_UnitConverter_t
, QtPrivate::TypeAndForceComplete<UnitConverter, std::true_type>
...
static constexpr unsigned char qt_pluginMetaData_UnitConverter[] = {
    'Q', 'T', 'M', 'E', 'T', 'A', 'D', 'A', 'T', 'A', ' ', '!',
...
QT_MOC_EXPORT_PLUGIN(UnitConverter, UnitConverter)
