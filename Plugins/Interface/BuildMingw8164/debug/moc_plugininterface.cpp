...
QT_MOC_LITERAL(16, 13), // "processedData"
QT_MOC_LITERAL(30, 0), // ""
QT_MOC_LITERAL(31, 6) // "Signal"

    },
    "PluginInterface\0processedData\0\0Signal"
};
...
void PluginInterface::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->processedData((*reinterpret_cast< const Signal(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (PluginInterface::*)(const Signal & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PluginInterface::processedData)) {
                *result = 0;
                return;
            }
        }
...
, QtPrivate::TypeAndForceComplete<PluginInterface, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<const Signal &, std::false_type>
...
// SIGNAL 0
void PluginInterface::processedData(const Signal & _t1)
{
